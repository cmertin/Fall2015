...
max_epochs = 20
sigma_list = [1e-10,1e-9,1e-8,1e-7,1e-6,1e-5,0.0001,0.001,0.01,0.1,1,10,100,1000,1e5,1e6,1e7,1e8,1e9,1e10]
gamma_list = [1e-10,1e-9,1e-8,1e-7,1e-6,1e-5,0.0001,0.001,0.01,0.1,1,10,100,1000,1e5,1e6,1e7,1e8,1e9,1e10]#[1e-10,1e-9,1e-8,1e-7,1e-6]
fold = 10
fold_max_epochs = 10
orig_plot = []
scaled_plot = []
