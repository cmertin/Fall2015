...
for protein in protein_list:
    ...
    write_domains = "var dom = script(\'show DOMAINS\'); write var dom " + prot_dir + prot + "_domains.dat; "
    write_amino = "var amino = script(\'show SEQUENCE\'); write var amino " + prot_dir + prot + "_aminos.dat; "
